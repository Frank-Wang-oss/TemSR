...
from models.loss import CrossEntropyLabelSmooth, EntropyLoss, MMD_loss, Temporal_EntropyLoss_v1, anchor_pull_loss, CORAL
...
class SFDA_DEMO(Algorithm):
    ...
    def __init__(self, backbone, configs, hparams, device):
        ...
        self.mmd_loss = MMD_loss(kernel_type='rbf', kernel_mul=2.0, kernel_num=5)  # as hparameter .
